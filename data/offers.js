...
const PLANS = [
  ...
  },
  {
    ...
    taxesIncluded: false,
    notes: "Essentials Saver 2.0 (Aug 2026): $50/line with AutoPay, $55 without. Taxes and fees extra.",
    source: "https://www.whistleout.com/CellPhones/Carriers/T-Mobile/Personal/T-Mobile-Essentials-Savings",
    features: {
      premiumData: 50,
      hotspotGB: 0,
      international: false,
      source: "https://saveonphone.com/plans/t-mobile-essentials-saver/",
      note: "50GB premium data, then may slow during congestion; unlimited hotspot at 3G speeds only (no high-speed allotment); 480p video.",
    },
  },
  // T-Mobile's own prepaid brand (formerly "Simply Prepaid"), relaunched
  // June 2025 with a 5-year price guarantee. Treated like Metro/Mint for
  // MVNO-toggle coverage purposes even though it's carrier-owned, not a
  // true MVNO.
  {
    id: "tmo-prepaid-starter",
    ...
    taxesIncluded: false,
    notes: "AutoPay pricing ($45 first month without). Taxes and fees extra. 5-year price guarantee on talk/text/data.",
    source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
    features: {
      premiumData: 15,
      hotspotGB: 0,
      ...
      source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
      note: "15GB of high-speed data, then slowed; hotspot draws from the same allotment. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "tmo-prepaid-unlimited",
    carrier: "T-Mobile Prepaid",
    ...
    taxesIncluded: false,
    notes: "AutoPay pricing ($50 first month without). Taxes and fees extra. 5-year price guarantee on talk/text/data.",
    source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
    features: {
      premiumData: 50,
      hotspotGB: 0,
      ...
      international: false,
      source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
      note: "50GB premium data, then may slow; unlimited hotspot at 3G speeds only (no high-speed allotment). QCI 7 on T-Mobile.",
    },
  },
  {
    id: "tmo-prepaid-unlimited-plus",
    carrier: "T-Mobile Prepaid",
    ...
    perLine: {
      ...
      3: { price: 60, estimated: true },
      4: { price: 60, estimated: true },
      5: { price: 60, estimated: true },
    },
    taxesIncluded: false,
    notes: "AutoPay pricing ($65 first month without). Taxes and fees extra. 5-year price guarantee on talk/text/data.",
    source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
    features: {
      premiumData: 50,
      hotspotGB: 5,
      ...
      estimatedFeatures: ["premiumData"],
      source: "https://www.t-mobile.com/news/offers/t-mobile-prepaid-introduces-new-perk-packed-plans",
      note: "50GB premium data, 5GB high-speed hotspot then 3G; unlimited talk/text while roaming in Mexico and Canada, unlimited texting to 215+ destinations. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "tmo-more",
  ...
  },
  {
    ...
    segmentDiscounts: {
      military: { percent: 0.1, source: "https://www.att.com/offers/discount-program/appreciation/" },
      firstResponder: { percent: 0.1, source: "https://www.att.com/offers/discount-program/appreciation/" },
      healthcare: { percent: 0.1, source: "https://www.att.com/offers/discount-program/appreciation/" },
      teacher: { percent: 0.1, source: "https://www.att.com/offers/discount-program/appreciation/" },
    },
    features: {
      premiumData: 5,
      hotspotGB: 3,
  ...
  },
  {
    ...
    source: "https://shopcellplans.com/att-plans/",
    segmentDiscounts: {
      military: { percent: 0.15, source: "https://www.att.com/offers/discount-program/appreciation/" },
      firstResponder: { percent: 0.15, source: "https://www.att.com/offers/discount-program/appreciation/" },
      healthcare: { percent: 0.15, source: "https://www.att.com/offers/discount-program/appreciation/" },
      teacher: { percent: 0.15, source: "https://www.att.com/offers/discount-program/appreciation/" },
    },
    features: {
      premiumData: 100,
      hotspotGB: 50,
      international: false,
      source: "https://www.att.com/support/article/wireless/KM1182926/",
      note: "100GB priority data, then deprioritized; 50GB hotspot.",
    },
  },
  {
    id: "att-premium",
    ...
    taxesIncluded: false,
    notes: "Unlimited premium data. Required for AT&T's biggest device promos.",
    source: "https://shopcellplans.com/att-plans/",
    segmentDiscounts: {
      military: { percent: 0.2, source: "https://www.att.com/offers/discount-program/appreciation/" },
      firstResponder: { percent: 0.2, source: "https://www.att.com/offers/discount-program/appreciation/" },
      healthcare: { percent: 0.2, source: "https://www.att.com/offers/discount-program/appreciation/" },
      teacher: { percent: 0.2, source: "https://www.att.com/offers/discount-program/appreciation/" },
      student: { percent: 0.2, source: "https://www.att.com/verification/signaturehub/" },
    },
    features: {
      premiumData: "unlimited",
      hotspotGB: 100,
  ...
  },
  {
    ...
    perLine: {
      ...
      3: { price: 85 },
      4: { price: 75 },
      5: { price: 75, estimated: true },
    },
    taxesIncluded: false,
    notes:
      "Top tier above Premium 2.0: Turbo prioritization plus one tablet and one watch line included per phone line.",
    source: "https://www.att.com/support/article/wireless/KM1182926/",
    // Appreciation-discount coverage of Elite 2.0 is unpublished, so no
    // segmentDiscounts here until a source confirms it.
    features: {
      premiumData: "unlimited",
      hotspotGB: 250,
      international: true,
      ...
      note: "250GB high-speed hotspot; 20GB of data in 210+ international destinations; AT&T Turbo included.",
    },
  },
  ...
  // some MVNOs offer multi-line discounts not captured here.
  {
    ...
    source: "https://www.visible.com/plans",
    features: {
      premiumData: 0,
      hotspotGB: 0,
      international: false,
      source: "https://www.visible.com/plans",
      note: "Deprioritized on Verizon; unlimited hotspot capped at 5 Mbps (no high-speed allotment).",
    },
  },
  {
    id: "visible-plus",
    ...
    taxesIncluded: true,
    notes: "Prepaid, taxes and fees included; flat price at every line count.",
    source: "https://www.visible.com/plans",
    features: {
      premiumData: "unlimited",
      hotspotGB: 0,
      international: false,
      estimatedFeatures: ["international"],
      source: "https://www.verizon.com/about/news/visible-unveils-new-visible-pro-and-enhanced-visible-plans",
      note: "Unlimited premium data with 5G Ultra Wideband; unlimited hotspot capped at 10 Mbps (no high-speed allotment).",
    },
  },
  {
    id: "visible-plus-pro",
    ...
    taxesIncluded: true,
    notes: "Prepaid, taxes and fees included; smartwatch service included with compatible devices.",
    source: "https://www.visible.com/plans",
    features: {
      premiumData: "unlimited",
      hotspotGB: 0,
      ...
      estimatedFeatures: ["international"],
      source: "https://www.verizon.com/about/news/visible-unveils-new-visible-pro-and-enhanced-visible-plans",
      note: "Unlimited premium data on Verizon's fastest 5G Ultra Wideband; unlimited hotspot capped at 15 Mbps; 4K UHD streaming.",
    },
  },
  // Mint prices are per line at any line count (each line carries its own
  // plan; no multi-line discount): the 12-month renewal rate, with the
  // any-plan $15/mo new-customer rate as intro pricing.
  {
    id: "mint",
    carrier: "Mint Mobile",
    name: "Mint Unlimited",
    ...
    source: "https://www.mintmobile.com/plans/",
    features: {
      premiumData: 50,
      hotspotGB: 20,
      international: false,
      source: "https://www.mintmobile.com/plans/",
      note: "Speeds may drop after 50GB/mo when the network is busy; 20GB hotspot. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "mint-6gb",
    ...
    taxesIncluded: false,
    notes: "Prepaid annually. 6GB of high-speed data per month.",
    source: "https://www.mintmobile.com/plans/",
    features: {
      premiumData: 6,
      hotspotGB: 6,
      ...
      estimatedFeatures: ["hotspotGB"],
      source: "https://www.mintmobile.com/plans/",
      note: "6GB high-speed data; hotspot draws from the plan's data allotment. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "mint-17gb",
    ...
    taxesIncluded: false,
    notes: "Prepaid annually. 17GB of high-speed data per month.",
    source: "https://www.mintmobile.com/plans/",
    features: {
      premiumData: 17,
      hotspotGB: 17,
      ...
      estimatedFeatures: ["hotspotGB"],
      source: "https://www.mintmobile.com/plans/",
      note: "17GB high-speed data; hotspot draws from the plan's data allotment. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "mint-23gb",
    ...
    taxesIncluded: false,
    notes: "Prepaid annually. 23GB of high-speed data per month.",
    source: "https://www.mintmobile.com/plans/",
    features: {
      premiumData: 23,
      hotspotGB: 23,
      ...
      estimatedFeatures: ["hotspotGB"],
      source: "https://www.mintmobile.com/plans/",
      note: "23GB high-speed data; hotspot draws from the plan's data allotment. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "metro-starter-plus",
    carrier: "Metro",
    name: "Metro Starter Plus",
    tier: "base",
    mvno: true,
    network: "T-Mobile",
    perLine: {
    ...
    taxesIncluded: true,
    notes: "Taxes and fees included; no AutoPay required. New single-line BYOD customers can get unlimited for $25/mo instead.",
    source: "https://www.metrobyt-mobile.com/phone-plans",
    features: {
      premiumData: 35,
      hotspotGB: 0,
      priceGuaranteeYears: 5,
      international: false,
      source: "https://www.metrobyt-mobile.com/phone-plans",
      note: "35GB high-speed data; no hotspot on this tier. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "metro",
    carrier: "Metro",
    name: "Metro Flex Unlimited",
    tier: "base",
    mvno: true,
    network: "T-Mobile",
    perLine: {
      ...
      3: { price: 37, estimated: true },
      4: { price: 30 },
      5: { price: 30, estimated: true },
    },
    taxesIncluded: true,
    notes: "AutoPay pricing, taxes and fees included. T-Mobile's prepaid brand, April 2025 lineup.",
    source: "https://www.metrobyt-mobile.com/blog/newsroom/metro-new-plans",
    features: {
      premiumData: 0,
      hotspotGB: 8,
      priceGuaranteeYears: 5,
      ...
      estimatedFeatures: ["premiumData"],
      source: "https://www.metrobyt-mobile.com/blog/newsroom/metro-new-plans",
      note: "Unlimited data with an unpublished priority allotment; 8GB hotspot. QCI 7 on T-Mobile.",
    },
  },
  {
    id: "metro-flex-plus",
    carrier: "Metro",
    name: "Metro Flex Unlimited Plus",
    tier: "mid",
    mvno: true,
    network: "T-Mobile",
    perLine: {
      1: { price: 60 },
      2: { price: 53, estimated: true },
      3: { price: 47, estimated: true },
      4: { price: 40, estimated: true },
      5: { price: 40, estimated: true },
    },
    taxesIncluded: true,
    notes: "AutoPay pricing, taxes and fees included; Amazon Prime membership included.",
    source: "https://www.metrobyt-mobile.com/blog/newsroom/metro-new-plans",
    features: {
      premiumData: 70,
      hotspotGB: 25,
      ...
      international: false,
      source: "https://www.metrobyt-mobile.com/blog/newsroom/metro-new-plans",
      note: "70GB high-speed data; 25GB hotspot; unlimited texting from the US to 210+ destinations (roaming not included). QCI 7 on T-Mobile.",
    },
  },
  {
    id: "cricket-sensible",
    ...
    taxesIncluded: true,
    notes: "AutoPay pricing ($35 without), taxes and fees included. Only Cricket's unlimited plans carry multi-line discounts, so this one is flat.",
    source: "https://www.cricketwireless.com/cell-phone-plans",
    features: {
      premiumData: 10,
      hotspotGB: 0,
      international: false,
      estimatedFeatures: ["hotspotGB"],
      source: "https://www.cricketwireless.com/cell-phone-plans",
      note: "10GB of data, then slowed; no Mexico/Canada use on this tier.",
    },
  },
  {
    id: "cricket-smart",
    ...
    perLine: {
      1: { price: 45 },
      2: { price: 40, estimated: true },
      3: { price: 33, estimated: true },
      4: { price: 27.5 },
      5: { price: 27.5, estimated: true },
    },
    taxesIncluded: true,
    notes: "AutoPay pricing ($50 without), taxes and fees included. Calling/texting/data in Mexico and Canada.",
    source: "https://www.cricketwireless.com/support/plans-and-features/family-plans.html",
    features: {
      premiumData: 0,
      hotspotGB: 15,
      international: false,
      estimatedFeatures: ["premiumData"],
      source: "https://www.whistleout.com/CellPhones/Guides/best-cricket-wireless-plans",
      note: "Unlimited data, priority allotment not published; 15GB hotspot. Mexico/Canada use included (not counted as international coverage).",
    },
  },
  {
    id: "cricket",
    carrier: "Cricket",
    name: "Supreme Unlimited",
    tier: "mid",
    mvno: true,
    network: "AT&T",
    perLine: {
      ...
      3: { price: 40, estimated: true },
      4: { price: 32.5 },
      5: { price: 32.5, estimated: true },
    },
    taxesIncluded: true,
    notes: "AutoPay pricing ($60 without), taxes and fees included. Replaces the old Unlimited + 15GB Hotspot plan.",
    source: "https://www.cricketwireless.com/support/plans-and-features/family-plans.html",
    features: {
      premiumData: 0,
      hotspotGB: 50,
      ...
      estimatedFeatures: ["premiumData"],
      source: "https://www.whistleout.com/CellPhones/Guides/best-cricket-wireless-plans",
      note: "Unlimited data at Cricket's highest priority; 50GB hotspot; international texting and Mexico/Canada use included (roaming-based coverage not counted).",
    },
  },
  {
    id: "fi-essentials",
    ...
    network: "T-Mobile",
    perLine: {
      // Published group totals: $35 / $60 / $80; the 3-line total is not
      // an even split, so the per-line price is stored as the exact
      // fraction. 4- and 5-line totals differ between sources ($90–$92),
      // so those stay estimated.
      1: { price: 35 },
      2: { price: 30 },
      3: { price: 80 / 3 },
      4: { price: 22.5, estimated: true },
      5: { price: 22.6, estimated: true },
    },
    taxesIncluded: false,
    notes: "No hotspot tethering on this tier.",
    source: "https://fi.google.com/about/plans/unlimited-essentials",
    features: {
      premiumData: 30,
      hotspotGB: 0,
      international: false,
      source: "https://fi.google.com/about/plans/unlimited-essentials",
      note: "30GB high-speed data, then 256 Kbps; no hotspot. QCI 6 priority on T-Mobile within the allotment.",
    },
  },
  {
    id: "fi-standard",
    ...
    features: {
      ...
      note: "50GB high-speed data, then 256 Kbps; 25GB hotspot. QCI 6 priority on T-Mobile within the allotment.",
    },
  },
  {
    id: "fi-premium",
...

  {
    ...
    taxesIncluded: true,
    notes: "Taxes and fees included; flat per-line pricing, cheaper on annual prepay.",
    source: "https://www.usmobile.com/plans",
    features: {
      premiumData: 70,
      hotspotGB: 10,
      international: false,
      source: "https://www.usmobile.com/help/docs/our-plans/core-plans/unlimited-data-plans",
      note: "70GB high-speed data and 10GB hotspot on the Verizon (Warp) and T-Mobile (Light Speed) networks; unlimited high-speed and 20GB hotspot on AT&T (Dark Star). The lower published values are recorded.",
    },
  },
  {
    id: "us-mobile-flex",
    ...
    taxesIncluded: true,
    notes: "Taxes and fees included; billed annually at this monthly equivalent.",
    source: "https://www.usmobile.com/plans",
    features: {
      premiumData: 10,
      hotspotGB: 0,
      ...
      note: "10GB soft cap before slowdown; hotspot allotment not captured.",
    },
  },
  {
    id: "us-mobile-premium",
    carrier: "US Mobile",
    name: "Unlimited Premium",
    tier: "mid",
    mvno: true,
    ...
    features: {
      ...
      international: false,
      estimatedFeatures: ["international"],
      source: "https://www.usmobile.com/blog/best-unlimited-data-plan/",
      note: "Unlimited premium data; 50GB high-speed hotspot (unlimited at reduced speed after).",
    },
  },
  {
    id: "boost-unlimited",
    ...
    tier: "base",
    mvno: true,
    network: "AT&T (Boost connects through AT&T since Nov 2025)",
    perLine: {
      1: { price: 25 },
      2: { price: 25, estimated: true },
      3: { price: 25, estimated: true },
      4: { price: 25, estimated: true },
      5: { price: 25, estimated: true },
    },
    taxesIncluded: false,
    notes: "$25/mo with AutoPay; hotspot is a $10/mo add-on on this tier.",
    source: "https://www.boostmobile.com/plans/affordable-phone-plan",
    features: {
      premiumData: 30,
      hotspotGB: 0,
      international: false,
      source: "https://help.boostmobile.com/docs/unlimited-plans",
      note: "30GB premium data, then deprioritized; no hotspot included.",
    },
  },
  {
    id: "boost-global",
    ...
    taxesIncluded: false,
    notes: "$40/mo with AutoPay ($45 without); talk and text from the US to 190+ destinations. Hotspot is a $10/mo add-on.",
    source: "https://help.boostmobile.com/docs/unlimited-plans",
    features: {
      premiumData: 40,
      hotspotGB: 0,
      international: false,
      source: "https://help.boostmobile.com/docs/unlimited-plans",
      note: "40GB premium data. International calling FROM the US is included; international roaming is not — hence not counted as international coverage.",
    },
  },
  {
    id: "boost-plus",
    ...
    taxesIncluded: false,
    notes: "$50/mo with AutoPay; hotspot included.",
    source: "https://help.boostmobile.com/docs/unlimited-plans",
    features: {
      premiumData: 40,
      hotspotGB: 0,
      ...
      estimatedFeatures: ["hotspotGB"],
      source: "https://help.boostmobile.com/docs/unlimited-plans",
      note: "40GB premium data; hotspot included but its allotment is not published.",
    },
  },
  {
    id: "boost-premium",
    ...
    taxesIncluded: false,
    notes: "$60/mo with AutoPay; hotspot included.",
    source: "https://help.boostmobile.com/docs/unlimited-plans",
    features: {
      premiumData: 50,
      hotspotGB: 0,
      ...
      estimatedFeatures: ["hotspotGB"],
      source: "https://help.boostmobile.com/docs/unlimited-plans",
      note: "50GB premium data; hotspot included but its allotment is not published.",
    },
  },
  {
    id: "total-starter",
