...
const QCI_BY_PLAN = {
  ...
  "mint-6gb": { value: 7, note: "T-Mobile MVNOs like Mint ride at QCI 7 — same as Essentials and Metro." },
  "mint-17gb": { value: 7, note: "T-Mobile MVNOs like Mint ride at QCI 7 — same as Essentials and Metro." },
  "mint-23gb": { value: 7, note: "T-Mobile MVNOs like Mint ride at QCI 7 — same as Essentials and Metro." },
  "metro-starter-plus": { value: 7, note: "Metro rides at QCI 7 — same tier as T-Mobile Essentials." },
  "metro": { value: 7, note: "Metro rides at QCI 7 — same tier as T-Mobile Essentials." },
  "metro-flex-plus": { value: 7, note: "Metro rides at QCI 7 — same tier as T-Mobile Essentials." },
  ...
  "boost-unlimited": { value: 9, note: "Priority on AT&T for the premium-data allotment not published — assumed deprioritized; verify." },
  "boost-global": { value: 9, note: "Priority on AT&T for the premium-data allotment not published — assumed deprioritized; verify." },
  "boost-plus": { value: 9, note: "Priority on AT&T for the premium-data allotment not published — assumed deprioritized; verify." },
  "boost-premium": { value: 9, note: "Priority on AT&T for the premium-data allotment not published — assumed deprioritized; verify." },
